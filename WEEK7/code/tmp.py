...
match = re.search(r'\s', my_string)# search for spaces in the string
print(match)
match.group()

match = re.search(r'\d', my_string)# search for numeric characters in string.
print(match)
