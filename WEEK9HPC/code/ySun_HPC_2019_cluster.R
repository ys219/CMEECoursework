...
## I have tried cp $HOME/ySun_HPC_2019_main.R $TMPDIR
## but still wouldn't able to source the functions, so i paste all the functions here

# Alt + o to fold everything and navigate to cluster run code in r studio
...
species_abundance <- function(community)  {
  community = as.vector(sort(table(community),decreasing = TRUE))
  return(community)
}
